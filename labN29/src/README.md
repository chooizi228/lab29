...
являются все целые числа. Берём максимально возможные значения ячейки int.

|              | Тип                  | min значение | max значение |
|--------------|----------------------|--------------|--------------|
| X1 (Число 1) | Целочисленное число  | -10^9        | 10^9         |
| X2 (Число 2) | Целочисленное число  | -10^9        | 10^9         |
| X3 (Число 3) | Целочисленное число  | -10^9        | 10^9         |
| X4 (Число 4) | Целочисленное число  | -10^9        | 10^9         |
...
|         | Тип                                 | min значение | max значение |
|---------|-------------------------------------|--------------|--------------|
| Число 1 | Целочисленное неотрицательное число | -10^9        | -1           |
